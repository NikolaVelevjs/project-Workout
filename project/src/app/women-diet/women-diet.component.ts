...
@Component({
  selector: 'app-women-diet',
  templateUrl: './women-diet.component.html',
  styleUrls: ['./women-diet.component.css']
})
export class WomenDietComponent implements OnInit {
  ...
  sort(Diet: any[], program : string){
    let sortedDiets = Diet.filter(diet=> diet.gender == "woman")
